# 语义文档修订 Haiku v4 Live authorization batch 2

- Status: `approved-live-authorized`
- Batch ID: `haiku-v4-semantic-document-revision-live-authorization-batch-v2`
- Batch SHA-256: `sha256:01de29b0b0c58a0961592fd1f2a312ad4dbb1b1f7417f49047077d6b452056e0`
- Manifest: [`eval-live-authorization-batch-v4-semantic-document-revision-v2.json`](./eval-live-authorization-batch-v4-semantic-document-revision-v2.json)
- Scope: 仅 fresh 复测 Product Skill bytes 已变化且 v1 Live 仍失败的 `brainstorming-semantic-revision` 与 `generating-tasks-semantic-revision`；已通过且 owner bytes 未变化的 `manage-specs-semantic-revision` 不重复运行。
...
- Live approval ID: [`live-brainstorming-semantic-revision-haiku-v4-v2`](../../../test/skill-evals/brainstorming-semantic-revision/live-approval.json)
...
- Current Skill snapshot: `brainstorming` / `current-explicit-file` = `1b6e1254d3f9c29fb0a7384267462de0cbcf83c6e1dcbbbd0ed74ddbc8fcd225`
...
- Live approval ID: [`live-generating-tasks-semantic-revision-haiku-v4-v2`](../../../test/skill-evals/generating-tasks-semantic-revision/live-approval.json)
