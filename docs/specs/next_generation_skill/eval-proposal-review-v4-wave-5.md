# Haiku v4 Baseline Proposal 批量审核 — 5 explicit workflows

- Status: `pending-user-review`
- Batch ID: `haiku-v4-wave-5-explicit-workflows`
- Batch SHA-256: `sha256:e207656bdbac671e350c08ccbe0b6a2a0f83c53479aa35c7e9b1dac64bf1ed7c`
- Manifest: [`eval-proposal-batch-v4-wave-5.json`](./eval-proposal-batch-v4-wave-5.json)
- Scope: `10` 个待审 Protocol v4 Proposal，覆盖 `crash-audit、landing、takeoff、test-driven-development、using-git-worktrees`；全部计入候选产品 Skill 覆盖，但只有后续真实 Red、Live 通过并由用户接受后才成为 accepted coverage。
- Run state at review creation: 未启动任何本 Batch 的 Haiku Baseline、Live Eval、Implementer 或 Reviewer，也未生成新的运行证据。

## 这次审核的边界

本页与 manifest 固定当前 `10` 个 Scenario、Protocol、Fixture 与共享用户价值 rubric 的完整输入。批准顶部的 Batch ID 和 Batch SHA-256 后，授权的仅是这批完全绑定输入的 **Baseline Observation**；不接受任何 Skill 输出，不授权生产代码修改，不授权 Live Eval，也不代替后续对 Scorecard 的用户决定。
...
已逐项复核 `10` 个 pending v4 Fixture。Implementer 可见：
...
- Proposal ID: [`proposal-tdd-approved-task-trigger-v3-haiku-v4`](../../../test/skill-evals/tdd-approved-task-trigger-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/tdd-approved-task-trigger-v3/protocol.json`](../../../test/skill-evals/tdd-approved-task-trigger-v3/protocol.json) = `19e7e4cdd32cfa106d25fcc4f721636363df579ae3befad460443bf2df5ca9af`
...
- Proposal ID: [`proposal-tdd-user-trigger-v3-haiku-v4`](../../../test/skill-evals/tdd-user-trigger-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/tdd-user-trigger-v3/protocol.json`](../../../test/skill-evals/tdd-user-trigger-v3/protocol.json) = `a0f8256dfa243ba496aca0490984de40a159f1a5da9ab4280ebf285e0c749905`
...
- Proposal ID: [`proposal-worktree-explicit-bundle-isolation-v3-haiku-v4`](../../../test/skill-evals/worktree-explicit-bundle-isolation-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/worktree-explicit-bundle-isolation-v3/protocol.json`](../../../test/skill-evals/worktree-explicit-bundle-isolation-v3/protocol.json) = `905addb737bddde404d8e6b9e33cc4e486cdf2037a5f04b7675b310b2fc118a7`
...
- Proposal ID: [`proposal-worktree-explicit-create-v3-haiku-v4`](../../../test/skill-evals/worktree-explicit-create-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/worktree-explicit-create-v3/protocol.json`](../../../test/skill-evals/worktree-explicit-create-v3/protocol.json) = `c29644d6c901b952af6fc0f680e34326a83acb221ce415960474f8a714f9a1be`
...
- Proposal ID: [`proposal-crash-audit-calibrated-none-v3-haiku-v4`](../../../test/skill-evals/crash-audit-calibrated-none-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/crash-audit-calibrated-none-v3/protocol.json`](../../../test/skill-evals/crash-audit-calibrated-none-v3/protocol.json) = `56b19deb9a31c0d6c82e079b989899842fbc69f53ef17c7b6f8cc213c1b5b958`
...
- Proposal ID: [`proposal-crash-audit-release-blind-spot-v3-haiku-v4`](../../../test/skill-evals/crash-audit-release-blind-spot-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/crash-audit-release-blind-spot-v3/protocol.json`](../../../test/skill-evals/crash-audit-release-blind-spot-v3/protocol.json) = `e9e60ccdb2cc12e9d2285afc4ab6580c386875be9669b379d44ebceecd0ba08c`
...
- Proposal ID: [`proposal-takeoff-delete-internal-compat-v3-haiku-v4`](../../../test/skill-evals/takeoff-delete-internal-compat-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/takeoff-delete-internal-compat-v3/protocol.json`](../../../test/skill-evals/takeoff-delete-internal-compat-v3/protocol.json) = `28ab51c162fcab4f30bbd5f47f4a71b177d28b1def8bb7e9a241d876824f5ad2`
...
- Proposal ID: [`proposal-takeoff-protect-real-contract-v3-haiku-v4`](../../../test/skill-evals/takeoff-protect-real-contract-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/takeoff-protect-real-contract-v3/protocol.json`](../../../test/skill-evals/takeoff-protect-real-contract-v3/protocol.json) = `f5e7a0377b6c816ad19cd8a1ca0a5f6fd84e0b8a79415785974b1578892e5065`
...
- Proposal ID: [`proposal-landing-explicit-durable-queue-v3-haiku-v4`](../../../test/skill-evals/landing-explicit-durable-queue-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/landing-explicit-durable-queue-v3/protocol.json`](../../../test/skill-evals/landing-explicit-durable-queue-v3/protocol.json) = `a61a8a579a0322f8ae807b66194edda30d98e5c4a7b957d4428a05209ff6659b`
...
- Proposal ID: [`proposal-landing-explicit-feasibility-v3-haiku-v4`](../../../test/skill-evals/landing-explicit-feasibility-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/landing-explicit-feasibility-v3/protocol.json`](../../../test/skill-evals/landing-explicit-feasibility-v3/protocol.json) = `bcd4746dc4281295275df74f006e4c077301bba307a4770c2988726acacb04a5`
