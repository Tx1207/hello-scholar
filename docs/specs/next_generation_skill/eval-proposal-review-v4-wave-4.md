# Haiku v4 Baseline Proposal 批量审核 — 4 convergence handoff

- Status: `pending-user-review`
- Batch ID: `haiku-v4-wave-4-convergence-handoff`
- Batch SHA-256: `sha256:7a82e5208d8471904127187ea069e2dc101270adc1f395e4c9f5b1eb0f1d50a7`
- Manifest: [`eval-proposal-batch-v4-wave-4.json`](./eval-proposal-batch-v4-wave-4.json)
- Scope: `4` 个待审 Protocol v4 Proposal，覆盖 `converge-to-spec、handoff`；全部计入候选产品 Skill 覆盖，但只有后续真实 Red、Live 通过并由用户接受后才成为 accepted coverage。
...
- Proposal ID: [`proposal-converge-completion-gate-v3-haiku-v4`](../../../test/skill-evals/converge-completion-gate-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/converge-completion-gate-v3/protocol.json`](../../../test/skill-evals/converge-completion-gate-v3/protocol.json) = `c0798537c5d37f9e349ae47cbb312e988d332483e96081ec3c6aa5f93128af70`
...
- Proposal ID: [`proposal-converge-to-spec-v3-haiku-v4`](../../../test/skill-evals/converge-to-spec-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/converge-to-spec-v3/protocol.json`](../../../test/skill-evals/converge-to-spec-v3/protocol.json) = `a57affedfd36ba2de9398294a26aa691c74be82e3b4ba39a5dd931e626e6d13f`
...
- Proposal ID: [`proposal-handoff-dirty-implementation-v3-haiku-v4`](../../../test/skill-evals/handoff-dirty-implementation-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/handoff-dirty-implementation-v3/protocol.json`](../../../test/skill-evals/handoff-dirty-implementation-v3/protocol.json) = `df03d83e984fb70cf460ced1879f3a65f0f6ab3ce9fbf69240a6c28e9768db36`
...
- Proposal ID: [`proposal-handoff-negative-experiment-v3-haiku-v4`](../../../test/skill-evals/handoff-negative-experiment-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/handoff-negative-experiment-v3/protocol.json`](../../../test/skill-evals/handoff-negative-experiment-v3/protocol.json) = `f33b5050f60a53838f73fb5aee86f194414a612b99d596a0c50724c760ea0aa3`
