# Sonnet v3 Baseline Proposal 批量审核 — Wave 6 — Router

- Status: `pending-user-review`
- Batch ID: `sonnet-v3-wave-6-router`
- Batch SHA-256: `sha256:44e40c861e0caa833f4a5c9a5832cc6a28070e198a73f7a3593781b2ebdf04bc`
- Manifest: [`eval-proposal-batch-v3-wave-6.json`](./eval-proposal-batch-v3-wave-6.json)
- Scope: `5` 个待审 Protocol v3 Proposal，覆盖 `using-helloscholar`；全部计入候选产品 Skill 覆盖，但只有后续真实 Red、Live 通过并由用户接受后才成为 accepted coverage。
- Run state at review creation: 未启动任何本 Batch 的 Sonnet Baseline、Live Eval、Implementer 或 Reviewer，也未生成新的运行证据。

## 这次审核的边界

本页与 manifest 固定当前 `5` 个 Scenario、Protocol、Fixture 与共享用户价值 rubric 的完整输入。若你以后批准顶部的 Batch ID 和 Batch SHA-256，授权的仅是这批完全绑定输入的 **Baseline Observation**；不接受任何 Skill 输出，不授权生产代码修改，不授权 Live Eval，也不代替后续对 Scorecard 的用户决定。
...
已逐项复核 `5` 个 pending v3 Fixture。Implementer 可见：
...
- Proposal ID: [`proposal-router-design-v3-sonnet`](../../../test/skill-evals/router-design-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/router-design-v3/protocol.json`](../../../test/skill-evals/router-design-v3/protocol.json) = `fe11c094b7f221ed778aca3cc1bb098b2bf3cbbce3b799ff7bbf60e36319e3d2`
...
- Proposal ID: [`proposal-router-execution-v3-sonnet`](../../../test/skill-evals/router-execution-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/router-execution-v3/protocol.json`](../../../test/skill-evals/router-execution-v3/protocol.json) = `50a72f186a23ec39e090290fb69e0a751d77d28f0b665faaee2dafe04f70239a`
...
- Proposal ID: [`proposal-router-experiment-v3-sonnet`](../../../test/skill-evals/router-experiment-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/router-experiment-v3/protocol.json`](../../../test/skill-evals/router-experiment-v3/protocol.json) = `a88a40fbe9c7a482f75161bb495d58bd211ff39b02bbadcba6043528ddbe3189`
...
- Proposal ID: [`proposal-router-fast-v3-sonnet`](../../../test/skill-evals/router-fast-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/router-fast-v3/protocol.json`](../../../test/skill-evals/router-fast-v3/protocol.json) = `74755fa162897127585a06f3f217bbb9b34951a1bdced569909ce30f5b48b1f2`
...
- Proposal ID: [`proposal-router-maintenance-v3-sonnet`](../../../test/skill-evals/router-maintenance-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/router-maintenance-v3/protocol.json`](../../../test/skill-evals/router-maintenance-v3/protocol.json) = `15a016f73b95737db91c314b763fd7f6fd6c8907a2f0ab5b62d99ed167034233`
