# Haiku v4 Baseline Proposal 批量审核 — 3 records docs

- Status: `pending-user-review`
- Batch ID: `haiku-v4-wave-3-records-docs`
- Batch SHA-256: `sha256:c394a011acdf1cb29783cf207dfc57f7c6ffce65964dc84335ccc23d6ef87b31`
- Manifest: [`eval-proposal-batch-v4-wave-3.json`](./eval-proposal-batch-v4-wave-3.json)
- Scope: `8` 个待审 Protocol v4 Proposal，覆盖 `docs-maintenance、record-experiment`；全部计入候选产品 Skill 覆盖，但只有后续真实 Red、Live 通过并由用户接受后才成为 accepted coverage。
- Run state at review creation: 未启动任何本 Batch 的 Haiku Baseline、Live Eval、Implementer 或 Reviewer，也未生成新的运行证据。

## 这次审核的边界

本页与 manifest 固定当前 `8` 个 Scenario、Protocol、Fixture 与共享用户价值 rubric 的完整输入。批准顶部的 Batch ID 和 Batch SHA-256 后，授权的仅是这批完全绑定输入的 **Baseline Observation**；不接受任何 Skill 输出，不授权生产代码修改，不授权 Live Eval，也不代替后续对 Scorecard 的用户决定。
...
已逐项复核 `8` 个 pending v4 Fixture。Implementer 可见：
...
- Proposal ID: [`proposal-record-exploration-backfill-v3-haiku-v4`](../../../test/skill-evals/record-exploration-backfill-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/record-exploration-backfill-v3/protocol.json`](../../../test/skill-evals/record-exploration-backfill-v3/protocol.json) = `e5af5257f675fa8358b53dd8d6183858f518fa65f281aa00343175b0114beb6d`
...
- Proposal ID: [`proposal-record-no-record-smoke-v3-haiku-v4`](../../../test/skill-evals/record-no-record-smoke-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/record-no-record-smoke-v3/protocol.json`](../../../test/skill-evals/record-no-record-smoke-v3/protocol.json) = `c9f42fe7e4580a6af3d9ef7d609b87919a40c8ffb77e9455a4ae19c8cf975c76`
...
- Proposal ID: [`proposal-record-formal-prelaunch-v3-haiku-v4`](../../../test/skill-evals/record-formal-prelaunch-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/record-formal-prelaunch-v3/protocol.json`](../../../test/skill-evals/record-formal-prelaunch-v3/protocol.json) = `e0b6683f4858924c490ff5e11ea4751278aea68b52bb01ca708458f7c7645af0`
...
- Proposal ID: [`proposal-record-terminal-evidence-v3-haiku-v4`](../../../test/skill-evals/record-terminal-evidence-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/record-terminal-evidence-v3/protocol.json`](../../../test/skill-evals/record-terminal-evidence-v3/protocol.json) = `c933f12980d0cd395ddfd46d432f15c0d5636be1513eb68d65307944956f5854`
...
- Proposal ID: [`proposal-docs-maintenance-architecture-v3-haiku-v4`](../../../test/skill-evals/docs-maintenance-architecture-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/docs-maintenance-architecture-v3/protocol.json`](../../../test/skill-evals/docs-maintenance-architecture-v3/protocol.json) = `8264d125e352a77ff6c9c956b415c7e9f8b3f5aa732ca2b44fa7ff4b55eff0e7`
...
- Proposal ID: [`proposal-docs-maintenance-check-v3-haiku-v4`](../../../test/skill-evals/docs-maintenance-check-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/docs-maintenance-check-v3/protocol.json`](../../../test/skill-evals/docs-maintenance-check-v3/protocol.json) = `5b682ab59525ed4d9fe12e3fec468191570b00eb809a6ed0a22706463ac06214`
...
- Proposal ID: [`proposal-docs-maintenance-index-v3-haiku-v4`](../../../test/skill-evals/docs-maintenance-index-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/docs-maintenance-index-v3/protocol.json`](../../../test/skill-evals/docs-maintenance-index-v3/protocol.json) = `82307c4866f3afed5af29ba33876ef88719dcdaf405d7ba11623ae7f440b8d50`
...
- Proposal ID: [`proposal-docs-maintenance-recover-v3-haiku-v4`](../../../test/skill-evals/docs-maintenance-recover-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/docs-maintenance-recover-v3/protocol.json`](../../../test/skill-evals/docs-maintenance-recover-v3/protocol.json) = `1f3d946a1711172b8daae445f6c26e15cf25274c71027c87cf7c5c70a7e10eda`
