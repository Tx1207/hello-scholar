# Sonnet v3 Baseline Proposal 批量审核 — Wave 2 — Plan 与 Tasks

- Status: `pending-user-review`
- Batch ID: `sonnet-v3-wave-2-plan-tasks`
- Batch SHA-256: `sha256:d3cd2fc8b940eaa6efa9e12de97638a47c9dae433578b8234199d21a8cef771e`
- Manifest: [`eval-proposal-batch-v3-wave-2.json`](./eval-proposal-batch-v3-wave-2.json)
- Scope: `4` 个待审 Protocol v3 Proposal，覆盖 `generating-tasks、writing-plans`；全部计入候选产品 Skill 覆盖，但只有后续真实 Red、Live 通过并由用户接受后才成为 accepted coverage。
...
- Proposal ID: [`proposal-writing-plans-bundle-v3-sonnet`](../../../test/skill-evals/writing-plans-bundle-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/writing-plans-bundle-v3/protocol.json`](../../../test/skill-evals/writing-plans-bundle-v3/protocol.json) = `b80f329682aa37a72687c3647b9b19b19af5f370cc2b446b9309f64b7d008400`
...
- Proposal ID: [`proposal-writing-plans-spec-gap-v3-sonnet`](../../../test/skill-evals/writing-plans-spec-gap-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/writing-plans-spec-gap-v3/protocol.json`](../../../test/skill-evals/writing-plans-spec-gap-v3/protocol.json) = `740643b7a48eaa91e8d089bc40aa393fdbc32db1c5534f2fe4b17badac6f95d8`
...
- Proposal ID: [`proposal-generating-tasks-product-feature-policy-v3-sonnet`](../../../test/skill-evals/generating-tasks-product-feature-policy-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/generating-tasks-product-feature-policy-v3/protocol.json`](../../../test/skill-evals/generating-tasks-product-feature-policy-v3/protocol.json) = `ece4ab5f639654ff1951287b46d8d04ec741e7604f5df0bc85dc1584d668c060`
...
- Proposal ID: [`proposal-generating-tasks-product-migration-v3-sonnet`](../../../test/skill-evals/generating-tasks-product-migration-v3/proposal-approval.json)
...
- Protocol: [`test/skill-evals/generating-tasks-product-migration-v3/protocol.json`](../../../test/skill-evals/generating-tasks-product-migration-v3/protocol.json) = `8bc53a991ec805e6f09c1e11fafa6aa96a6141ec2c5092d34020035a7f6e0f8f`
