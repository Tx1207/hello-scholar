# 语义文档修订 Haiku v4 Live authorization batch 3

- Status: `approved-live-authorized`
- Batch ID: `haiku-v4-semantic-document-revision-live-authorization-batch-v3`
- Batch SHA-256: `sha256:6702a8f688b4ab153de4be2de6cea70c39e1b687fe023ea92c0d82341ef994ad`
- Manifest: [`eval-live-authorization-batch-v4-semantic-document-revision-v3.json`](./eval-live-authorization-batch-v4-semantic-document-revision-v3.json)
- Scope: fresh 复测 `brainstorming-semantic-revision` 与尚未运行 v2 的 `generating-tasks-semantic-revision`。前者绑定补强后的 `brainstorming` Skill；后者 owner bytes 未变，但 v2 batch 因同批绑定输入变化整体归档后在本批重新授权。
...
- Live approval ID: [`live-brainstorming-semantic-revision-haiku-v4-v3`](../../../test/skill-evals/brainstorming-semantic-revision/live-approval.json)
...
- Current Skill snapshot: `brainstorming` / `current-explicit-file` = `92eb4dbe06bb9428764f0dcc13354777cc9019180b0eebb8ae1629a8603ccc73`
...
- Live approval ID: [`live-generating-tasks-semantic-revision-haiku-v4-v3`](../../../test/skill-evals/generating-tasks-semantic-revision/live-approval.json)
