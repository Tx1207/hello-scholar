# 语义文档修订 Haiku v4 Live authorization batch 6

- Status: `approved-live-authorized`
- Batch ID: `haiku-v4-semantic-document-revision-live-authorization-batch-v6`
- Batch SHA-256: `sha256:cfef77a01a1abd472d7d8c9bb4e43d267a3da90fd445bba4925e2d9e1186c89a`
- Manifest: [`eval-live-authorization-batch-v4-semantic-document-revision-v6.json`](./eval-live-authorization-batch-v4-semantic-document-revision-v6.json)
- Scope: fresh 复测 `brainstorming-semantic-revision` 与尚未执行的 `generating-tasks-semantic-revision`。前者绑定 accepted-artifact completion 修复后的 `brainstorming` Skill；后者因同批授权归档而重新绑定，owner bytes 未变。
...
- Live approval ID: [`live-brainstorming-semantic-revision-haiku-v4-v6`](../../../test/skill-evals/brainstorming-semantic-revision/live-approval.json)
...
- Current Skill snapshot: `brainstorming` / `current-explicit-file` = `76472327ac916c5b3d66f57cc8adb51ee3af43781ee0811ebf04f1d8fc9b5d11`
...
- Live approval ID: [`live-generating-tasks-semantic-revision-haiku-v4-v6`](../../../test/skill-evals/generating-tasks-semantic-revision/live-approval.json)
