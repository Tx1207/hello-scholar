# 语义文档修订 Haiku v4 Live authorization batch 8

- Status: `approved-live-authorized`
- Batch ID: `haiku-v4-semantic-document-revision-live-authorization-batch-v8`
- Batch SHA-256: `sha256:39bb191e458ba597aadbe1c45b81bd52724d1bfe51df2f29e05313efe8dab44a`
- Manifest: [`eval-live-authorization-batch-v4-semantic-document-revision-v8.json`](./eval-live-authorization-batch-v4-semantic-document-revision-v8.json)
- Scope: 仅 fresh 复测 `generating-tasks-semantic-revision`，绑定 phase/section structural placement Authority 修复后的 `generating-tasks` Skill。其他 owner 的当前有效 pass 保持不变。
...
- Live approval ID: [`live-generating-tasks-semantic-revision-haiku-v4-v8`](../../../test/skill-evals/generating-tasks-semantic-revision/live-approval.json)
...
- Current Skill snapshot: `generating-tasks` / `current-explicit-file` = `f8da9092a92560babb3f77f3d347d958e5cf5f6ea605800837436ca269023ed9`
