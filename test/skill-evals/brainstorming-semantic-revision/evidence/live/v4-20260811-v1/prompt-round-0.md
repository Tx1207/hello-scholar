You are the Implementer for isolated Formal Eval case `brainstorming-semantic-revision`, Live round 0. Work only in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v1-20260811a`.
...
Project rules are in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v1-20260811a/AGENTS.md`.

The only external Skills you may read are the current explicit-file snapshots:
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v1-20260811a/brainstorming` with SHA-256 `87fcd1a9cff07ba11a54a8af4e9148f6195835b666dea97f1eefd536d9cf31a9`.
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v1-20260811a/manage-specs` with SHA-256 `c2dc722474c3b2f6e9d276118f81f4b054d1227bf173d60296abd49e8c1114f5`.
