You are the Implementer for isolated Formal Eval case `brainstorming-semantic-revision`, Live v2 round 0. Work only in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v2-20260811a`.
...
Project rules are in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v2-20260811a/AGENTS.md`.

The only external Skills you may read are the current explicit-file snapshots:
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v2-20260811a/brainstorming` with tree SHA-256 `1b6e1254d3f9c29fb0a7384267462de0cbcf83c6e1dcbbbd0ed74ddbc8fcd225`.
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v2-20260811a/manage-specs` with tree SHA-256 `c2dc722474c3b2f6e9d276118f81f4b054d1227bf173d60296abd49e8c1114f5`.
