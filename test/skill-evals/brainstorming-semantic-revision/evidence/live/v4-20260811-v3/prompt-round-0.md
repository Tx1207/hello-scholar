You are the Implementer for isolated Formal Eval case `brainstorming-semantic-revision`, Live v3 round 0. Work only in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v3-20260811b`.
...
Project rules are in `/tmp/hello-scholar-eval-brainstorming-semantic-revision-live-v3-20260811b/AGENTS.md`.

The only external Skills you may read are the current explicit-file snapshots:
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v3-20260811b/brainstorming` with tree SHA-256 `92eb4dbe06bb9428764f0dcc13354777cc9019180b0eebb8ae1629a8603ccc73`.
- `/tmp/hello-scholar-eval-snapshots/brainstorming-semantic-revision-live-v3-20260811b/manage-specs` with tree SHA-256 `c2dc722474c3b2f6e9d276118f81f4b054d1227bf173d60296abd49e8c1114f5`.
