...
1. `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/brainstorming-spec-bundle/scenario.md`
2. `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/brainstorming-spec-bundle/protocol.json`
3. `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/brainstorming-spec-bundle/proposal-approval.json`
4. `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/user-value-rubric.json`
5. Every file in `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/brainstorming-spec-bundle/evidence/baseline/`
6. The final, read-only project tree at `/tmp/hello-scholar-eval-wave2-brainstorm-E3bfnO/brainstorming-spec-bundle/`
