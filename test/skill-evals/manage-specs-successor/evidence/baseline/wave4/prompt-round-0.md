...
- Working directory: `/tmp/hello-scholar-eval-wave4-manage-OmPeRU/manage-specs-successor`
...
- Project rules: read and obey `/tmp/hello-scholar-eval-wave4-manage-OmPeRU/manage-specs-successor/AGENTS.md` before action.
