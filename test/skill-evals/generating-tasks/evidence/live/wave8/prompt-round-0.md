...
- Working directory: `/tmp/hello-scholar-eval-wave8-z7pfyQ/generating-tasks`
...
- Project rules: read and obey `/tmp/hello-scholar-eval-wave8-z7pfyQ/generating-tasks/AGENTS.md` before action.
- Allowed Skill snapshot: read the complete directory `/xsb/hello-scholar/.worktrees/next-generation-skill/skills/superpowers-skills/generating-tasks` with SHA-256 `75150a3c847724bc0340d10da7bc82917221b2ffd435ede0fa63a66632afcb00` before action.
