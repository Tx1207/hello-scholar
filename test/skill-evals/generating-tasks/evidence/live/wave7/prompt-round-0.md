...
- Working directory: `/tmp/hello-scholar-eval-wave7-STyy8d/generating-tasks`
...
- Project rules: read and obey `/tmp/hello-scholar-eval-wave7-STyy8d/generating-tasks/AGENTS.md` before action.
