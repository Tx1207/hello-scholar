# Independent Reviewer Task: Wave 7

You are the independent Reviewer for this completed Live Eval. Work read-only and do not create, edit, stage, commit, or clean any file.
...
5. Every file in `/xsb/hello-scholar/.worktrees/next-generation-skill/test/skill-evals/generating-tasks/evidence/live/wave7/`
6. The final, read-only project tree at `/tmp/hello-scholar-eval-wave7-STyy8d/generating-tasks/`
