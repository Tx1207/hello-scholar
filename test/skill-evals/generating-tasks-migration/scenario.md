# Generating Tasks: Config Format Migration
...
`generating-tasks` is intentionally absent in the Baseline. Read the project rules, Architecture, Accepted Spec, Approved Plan, persisted profiles, source, tests, and package metadata. Do not replace the missing instructions by reading hello-scholar production files, the Task Packet, or another Eval scenario.

## Allowed Scope

- `hello-scholar/specs/config-format/SPEC-014-json-config-migration/tasks.md`.
- Generated global and Topic Indexes written through the absolute hello-scholar CLI.
