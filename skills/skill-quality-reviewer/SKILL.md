...
- "Evaluate this skill: ./.scholaragents/skills/api-helper"
...
```bash
# Example invocation
ls -la ./.scholaragents/skills/target-skill/
```
...
```
User: "Analyze skill quality for ./.scholaragents/skills/git-workflow"
...
```
User: "Review all skills in ./.scholaragents/skills and tell me what to fix first"
